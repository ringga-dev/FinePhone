package ngga.ring.finephone.ui.activity
...
class MainActivity : ComponentActivity() {
    private val viewModel by viewModels<DataStoreViewModels>()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContent {
            FinePhoneTheme (
                appTheme = viewModel.stateApp.theme,
                appThemeColor = viewModel.stateApp.themeColor
            ) {
